  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-12 text-yellow-300">
      ...
      <p className="mb-4">
        ...
        and capable of entering into a legally binding agreement. If you do not
      ...
      <p className="mb-4">
        ...
        in accordance with these Terms. You must not misuse or attempt to
        disrupt the operation of the site in any way.
      </p>
      ...
      <p className="mb-4">
        All content, design, and materials on this website are owned by or
      ...
      <p className="mb-4">
        We reserve the right to modify these Terms at any time. Any updates will
        be posted on this page with a revised effective date. Continued use of
        the site after such changes constitutes your acceptance of the new Terms.
      </p>
